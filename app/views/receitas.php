            ...
            <div class="row mx-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control" placeholder="Ex: caixa inicial">
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="form-group">
        ...
        <tbody>
            <?php foreach ($revenues as $revenue) : ?>
                <tr>
                    ...
                    <td><?= date("d-m-Y H:i:s", strtotime($revenue->created_at)) ?> </td>
                    <td><?= isset($revenue->updated_at) ? date("d-m-Y H:i:s", strtotime($revenue->updated_at)) : '' ?></td>
                    <td>
                        <div style="display: flex; justify-content: space-evenly; cursor: pointer;">
                            <a data-toggle="modal" data-target="#family_edit_<?= $revenue->id ?>">
                                <i class="fa-regular fa-pen-to-square icon-menu"></i>
                            </a>
                            <a data-toggle="modal" data-target="#family_delete_<?= $revenue->id ?>">
